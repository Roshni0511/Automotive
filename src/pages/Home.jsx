                        ...
                        <div className="container">
                            <div className="row align-items-center justify-content-center justify-content-lg-start">
                                <div className="col-10 col-lg-7 text-center text-lg-start">
                                    <h6 className="text-white text-uppercase mb-3 animated slideInDown">// Are you Looking Reliable //</h6>
                                    <h1 className="display-3 text-white mb-2 pb-2 animated slideInDown">Get Amazing Car Service</h1>
                                    <h1 className="display-3 text-white mb-4 pb-3 animated slideInDown">From Us</h1>
                ...
                <div className="carousel-item">
                    ...
                    <div className="carousel-caption d-flex align-items-center">
                        <div className="container">
                            <div className="row align-items-center justify-content-center justify-content-lg-start">
                                <div className="col-10 col-lg-7 text-center text-lg-start">
                                    <h6 className="text-white text-uppercase mb-3 animated slideInDown">// We Care Extra //</h6>
                                    <h1 className="display-3 text-white mb-2 pb-2 animated slideInDown">Modern Car Repair</h1>
                                    <h1 className="display-3 text-white mb-4 pb-3 animated slideInDown">We Provide Expert Service</h1>
                                    <a href="" className="btn btn-primary py-3 px-5 animated slideInDown">Learn More<i className="fa fa-arrow-right ms-3"></i></a>
                                </div>
                                <div className="col-lg-5 d-none d-lg-flex animated zoomIn">
      ...
      <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
        <div className="d-flex py-5 px-4">
          ...
          <div className="ps-4">
            ...
            <p>Our team includes certified experts trained to service all makes and models efficiently.</p>
      ...
      <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
        <div className="d-flex bg-light py-5 px-4">
          ...
          <div className="ps-4">
            ...
            <p>Experienced mechanics providing reliable, fast, and transparent service every time.</p>
            <a className="text-secondary border-bottom" href="">Read More</a>
          </div>
        </div>
      </div>
      ...
      <div className="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
        <div className="d-flex py-5 px-4">
          ...
          <div className="ps-4">
            ...
            <p>We use the latest diagnostic and repair tools for accurate and efficient solutions.</p>
            <a className="text-secondary border-bottom" href="">Read More</a>
          </div>
        </div>
      </div>
        ...
        <div className="container">
            ...
            <div className="owl-carousel testimonial-carousel position-relative">
                <div className="testimonial-item text-center">
                    ...
                    <p className="mb-0">“Very professional. I must say, very reasonably priced as well, staff is excellent, the facility is also excellent! I would highly recommend to try it! Excellent service with a transparent system. On time delivery.”</p>
                    </div>
                </div>
                <div className="testimonial-item text-center">
                    ...
                    <p>Navsari, Gujarat</p>
                    <div className="testimonial-text bg-light text-center p-4">
                    <p className="mb-0">“It was an wonderful experience. Automotive is a workshop of highly professional work force. They completely customized my car as per my requirement and delivered with complete ease. I recommend Automotive to all. Thanks and great job.”</p>
                    </div>
                </div>
                <div className="testimonial-item text-center">
                    ...
                    <p>Udhna, Gujarat</p>
                    <div className="testimonial-text bg-light text-center p-4">
                    <p className="mb-0">“Fantastic service, superb punctuality. Availed their service twice and truly most satisfying. The response of coordinator is prompt and she was greatly supportive. Thanks a lot..!!”</p>
                    </div>
                </div>
                <div className="testimonial-item text-center">
                    ...
                    <p>Surat, Gujarat</p>
                    <div className="testimonial-text bg-light text-center p-4">
                    <p className="mb-0">“This is my first time experience with Automotive. But, I would say the service of Automotive is much better in comparison to any authorized dealer in terms of quality, service and very reasonable charge.”</p>
                    </div>
                </div>
            </div>
        </div>
