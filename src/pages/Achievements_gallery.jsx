...
export default function Achievements_gallery() {
    ...
    <div className="container-fluid page-header mb-5 p-0" style={{backgroundImage: "url(assets/img/carousel-bg-1.jpg)"}}>
        <div className="container-fluid page-header-inner py-5">
            <div className="container text-center">
                <h1 className="display-3 text-white mb-3 animated slideInDown">Our Achievements </h1>
                <nav aria-label="breadcrumb">
                    <ol className="breadcrumb justify-content-center text-uppercase">
                        <li className="breadcrumb-item"><a href="/">Home</a></li>
                        <li className="breadcrumb-item text-white active" aria-current="page">Achievements gallery</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section id="gallery" className='gallery-content'>
      <div className="container">
        <div style={{textAlign:'center'}} className='wow fadeIn' data-wow-delay="0.1s">
            <h6 className="text-primary text-uppercase">// Achievements Gallery //</h6>
              <h1 className="mb-4">
                Our Automotive Achievements Gallery
              </h1>
        </div>
